...
<?php
    ...
    $features = [['channels/list', 'snippet,premieres,about&forUsername=USERNAME&id=CHANNEL_ID'], // could use ',' instead of '&' to describes that `forUsername` and `id` have the same aim
                 ...
                 ['videos/list', 'id,status,contentDetails,music,short,impressions,containsMusic,isPaidPromotion,isPremium,isMemberOnly,mostReplayed&id=VIDEO_ID&clipId=CLIP_ID&SAPISIDHASH=YOUR_SAPISIDHASH']];
