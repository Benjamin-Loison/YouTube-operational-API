...
<?php
    ...
    $features = [['channels', 'status,upcomingEvents,shorts,community,channels,about,approval,playlists&cId=C_ID&id=CHANNEL_ID&handle=HANDLE'],
                 ...
                 ['videos', 'id,status,contentDetails,music,short,impressions,musics,isPaidPromotion,isPremium,isMemberOnly,mostReplayed,qualities,chapters,isOriginal,isRestricted,snippet&id=VIDEO_ID&clipId=CLIP_ID&SAPISIDHASH=YOUR_SAPISIDHASH']];
