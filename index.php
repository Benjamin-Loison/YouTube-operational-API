...
<?php
    ...
    $features = [['channels', 'status,upcomingEvents,shorts,community,channels,about,approval,playlists,snippet&cId=C_ID&id=CHANNEL_ID&handle=HANDLE&forUsername=USERNAME'],
