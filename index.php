...
<?php
    ...
    $features = [['channels/list', 'snippet,premieres,shorts,community,channels,about&forUsername=USERNAME&id=CHANNEL_ID&handle=HANDLE'], // could use ',' instead of '&' to describe that `forUsername` and `id` have the same aim
